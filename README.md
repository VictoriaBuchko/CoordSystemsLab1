...
## 3. Перевірка коректності перетворень
...
## 4. Реалізація обчислення відстаней
...
## 5. Аналіз продуктивності (Бенчмаркінг)
...
Рисунок 15 – Код реалізації бенчмаркінгу

![Результати бенчмаркінгу](img15.png)  
Рисунок 16 – Результати вимірювання продуктивності (консольний вивід)
